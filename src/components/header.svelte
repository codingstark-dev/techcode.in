<nav class="bg-white px-8 pt-2 ">
  ...
  <div class="-mb-px flex justify-center">
    <!-- <img src="https://pstouch.now.sh/images/pstouchapk.png" class="px-3 my-px" alt="" /> -->
    <a href="/" class="focus:outline-none flex-1 py-3">
      <h1
        class="font-black text-base md:text-xl uppercase hover:text-indigo-500
        transition-color duration-150">
        Techcode<span class="text-gray-600">.in</span>
      </h1>
    </a>
    <a
